...
To determine the outlet positions, I applied the PFF streamline equation using the calculated values for the pinched width (wp=0.65) and broad section width ($$w_b$$=40.65). 
