...
and 0.60 mm for the small particle outlet (lowest flow). 

Using the buffer channel (18 mm long) as the baseline, I scaled the other outlet lengths to maintain approximately equal pressure drops. 
